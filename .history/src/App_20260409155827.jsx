...
function LoginModal({ isOpen, onClose, lang }) {
  ...
  <>
    ...
    <button style={{
      ...
      fontWeight: 600, color: "#3c3c3c", cursor: "pointer",
        ...
        <div style={{ padding: mobile ? "28px 24px" : "36px 40px" }}>
          {view === "login" ? (
            <>
              ...
              <button style={{
                width: "100%", padding: "15px", background: "#e8740c", color: "#fff",
                border: "none", borderRadius: 10, fontSize: 14, fontWeight: 700,
                letterSpacing: 1.5, textTransform: "uppercase", cursor: "pointer",
                fontFamily: "'Outfit',sans-serif", transition: "all 0.3s",
                boxShadow: "0 4px 16px rgba(232,116,12,0.3)"
              }}
                onMouseEnter={e => { e.currentTarget.style.background = "#c96000"; e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(232,116,12,0.4)"; }}
              ...
              <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "#999", fontFamily: "'Outfit',sans-serif" }}>
                {L.loginNoAccount}{" "}
                <a href="#" onClick={e => { e.preventDefault(); setView("signup"); }} style={{ color: "#e8740c", textDecoration: "none", fontWeight: 600 }}
            ...
            <>
              ...
              <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "#999", fontFamily: "'Outfit',sans-serif" }}>
                {L.signupHaveAccount}{" "}
                <a href="#" onClick={e => { e.preventDefault(); setView("login"); }} style={{ color: "#e8740c", textDecoration: "none", fontWeight: 600 }}
                  onMouseEnter={e => e.target.style.textDecoration = "underline"}
                  onMouseLeave={e => e.target.style.textDecoration = "none"}>
                  {L.signupLogin}
                </a>
...
/* ── NAVBAR ──────────────────────────────────────────── */
function Navbar({ scrolled, lang, setLang, onLoginClick }) {
  const L = t[lang];
  const mobile = useIsMobile();
  ...
  return (
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
      ...
      <div style={{
        ...
        borderRadius: "0 16px 0 60px", transition: "all 0.4s"
      }} />
      <div style={{
        width: 48, height: 48, borderRadius: 12,
        background: hovered ? `${item.color}18` : "#f5f5f5",
        display: "flex", alignItems: "center", justifyContent: "center",
        marginBottom: mobile ? 16 : 20, transition: "all 0.4s"
      }}>
        <div style={{ width: 6, height: 6, borderRadius: "50%", background: item.color }} />
      </div>
      <h3 style={{
        fontFamily: "'Cormorant Garamond',Georgia,serif",
        fontSize: mobile ? 18 : 22, fontWeight: 700, color: "#0b1d3a",
        marginBottom: 10, lineHeight: 1.2
      }}>{item.title}</h3>
      <p style={{
        fontSize: mobile ? 13 : 14, color: "#777", lineHeight: 1.75,
        fontFamily: "'Outfit',sans-serif"
      }}>{item.desc}</p>
    </div>
  );
  ...
  return (
    <section id="services" style={{ padding: mobile ? "70px 20px" : "120px 40px", background: "#fff" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: "column", gap: mobile ? 28 : 48 }}>
        {svcData.map((s, i) => (
          <ServiceCard key={i} service={s} index={i} mobile={mobile} />
        ))}
      </div>
    </section>
  );
    ...
    <div ref={ref} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
      ...
      <div style={{ height: mobile ? 220 : 380, overflow: "hidden", direction: "ltr" }}>
        <img src={service.img} alt={service.title}
          style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.6s cubic-bezier(0.25,0.46,0.45,0.94)", transform: hovered ? "scale(1.06)" : "scale(1)" }} />
      </div>
...
function ContactSection({ lang }) {
  ...
  const contactInfoItems = [
    {
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e8740c" strokeWidth="2" strokeLinecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></svg>,
      title: lang === "en" ? "Our Location" : "Notre Emplacement",
      detail: L.contactAddress
    },
    {
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e8740c" strokeWidth="2" strokeLinecap="round"><path d="M22 16.92v3a2 2 0 01-2.18 2A19.86 19.86 0 013.09 5.18 2 2 0 015.11 3h3a2 2 0 012 1.72c.13.81.37 1.61.68 2.38a2 2 0 01-.45 2.11L8.09 11.5a16 16 0 006.41 6.41l2.29-2.25a2 2 0 012.11-.45c.77.31 1.57.55 2.38.68a2 2 0 011.72 2.03z" /></svg>,
      title: lang === "en" ? "Call Us" : "Appelez-Nous",
      detail: L.contactPhoneNum
    },
    {
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e8740c" strokeWidth="2" strokeLinecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>,
      title: lang === "en" ? "Email Us" : "\u00c9crivez-Nous",
      detail: L.contactEmailAddr
    }
  ];
        ...
        <div style={{ display: "grid", gridTemplateColumns: mobile ? "1fr" : "1fr 1.2fr", gap: mobile ? 36 : 60 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {contactInfoItems.map((item, i) => (
              <ContactInfoCard key={i} item={item} mobile={mobile} />
            ))}

          </div>

          <div style={{
            background: "#fff", borderRadius: 20, padding: mobile ? "28px 24px" : "44px 40px",
...
function ContactInfoCard({ item, mobile }) {
  ...
  return (
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
      ...
      <div style={{
        width: 48, height: 48, borderRadius: 12,
        background: hovered ? "rgba(232,116,12,0.1)" : "#fef8f2",
        display: "flex", alignItems: "center", justifyContent: "center",
        flexShrink: 0, transition: "all 0.35s"
      }}>
        {item.icon}
      </div>
      <div>
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", background: "#fff", color: "#0b1d3a", lineHeight: 1.6, overflowX: "hidden" }}>
      ...
      <Navbar scrolled={scrolled} lang={lang} setLang={setLang} onLoginClick={() => setLoginOpen(true)} />
      <Hero lang={lang} />
      <About lang={lang} />
